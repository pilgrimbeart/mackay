...
Professor Sir David John Cameron MacKay, M.A., Ph.D., FRS, FInstP, FICE (1967–2016) was an exceptional individual who combined clarity of thought with kindness and curiosity, changing people's lives directly and indirectly across many domains. He had a rare talent for turning messy questions into crisp, checkable reasoning and an insistence on *numbers, not adjectives*, delivered with wit, warmth and compassion.
...
- \chapterlink{chapter-foreword}{Foreword}
- \chapterlink{chapter-clarity}{Clarity of thought}
- \chapterlink{chapter-inference-group}{The Inference Group}
- \chapterlink{chapter-itila}{Information Theory, Inference, and Learning Algorithms}
- \chapterlink{chapter-sewtha}{Sustainable Energy - without the hot air}
- \chapterlink{chapter-dasher}{Dasher}
- \chapterlink{chapter-inspiration}{Inspiration}
- \chapterlink{chapter-last-word}{Last Word}
- \chapterlink{chapter-index}{Index of contributors}
